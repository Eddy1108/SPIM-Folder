...
MaterialTexture::MaterialTexture(GLuint shaderProgram, int textureIndex)
    : Material(shaderProgram, textureIndex)
{

}

void MaterialTexture::UpdateUniforms(glm::mat4* mMatrix)
{
...
void MaterialTexture::SetupUniforms()
{
    initializeOpenGLFunctions();
